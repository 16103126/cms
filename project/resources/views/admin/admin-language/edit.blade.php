...
@section('title', __('Edit Admin Language'))
        ...
        <div class="row">
            ...
            <div class="col-sm-10">
                <nav aria-label="breadcrumb">
                    ...
                    <li class="breadcrumb-item {{ (Request::is('admin/admin-language/edit*')) ? 'active' : '' }}">
                        <a href="{{ route('admin.admin-language.edit', $language->id) }}">@lang('Edit Admin Language')</a>
                    </li>
                    </ol>
                </nav>
                <div class="card mb-4">
                    <h5 class="card-header">@lang('Edit Admin Language')</h5>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-1"></div>
                            <div class="col-sm-10">
                                <form method="POST" action="{{ route('admin.admin-language.update', $language->id) }}">
                                    @csrf
