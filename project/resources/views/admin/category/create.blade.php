            ...
            <div class="col-sm-10">
                <nav aria-label="breadcrumb">
                    ...
                    <li class="breadcrumb-item {{ (Request::is('admin/category/create')) ? 'active' : '' }}">
                        <a href="{{ route('admin.category.create') }}">@lang('Create Category')</a>
                    </li>
                    </ol>
                </nav>
                <div class="card mb-4">
                            ...
                            <div class="col-sm-10">
                                <form method="POST" action="{{ route('admin.category.store') }}">
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-sm-9">
                                          <input type="text" name="name" class="form-control" id="basic-default-name" placeholder="{{ __('Enter category name') }}" required>
                                        </div>
                                    </div>
                                    <div class="row mb-5">
                                        <label class="col-sm-3 col-form-label" for="basic-default-name">@lang('Category slug')</label>
                                        <div class="col-sm-9">
                                          <input type="text" name="slug" class="form-control" id="basic-default-name" placeholder="{{ __('Enter category slug') }}" required>
                                        </div>
                                    </div>
                                    <div class="row mb-5">
