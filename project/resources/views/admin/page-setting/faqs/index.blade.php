        ...
        <div class="row">
            ...
            <div class="col-sm-10">
                <nav aria-label="breadcrumb">
                    ...
                    <li class="breadcrumb-item {{ (Request::is('admin/page/setting/faqs')) ? 'active' : '' }}">
                        <a href="{{ route('admin.page.setting.faqs') }}">@lang('Page Setting')</a>
                    </li>
                    </ol>
                </nav>
                <div class="card mb-4">
                    ...
                    <div class="card-header">
                        <a href="{{ route('admin.page.setting.faqs.create') }}" class="btn btn-primary">@lang('Add Faqs Page')</a>
                    </div>
                    <div class="card-body">
                        @include('partials.success')
                        @include('partials.error')
                        @foreach ($pages as $page)
                            <div class="modal fade" id="deleteFaqs{{ $page->id }}" tabindex="-1" style="display: none;" aria-hidden="true">
                                ...
                                <div class="modal-content">
                                    ...
                                    <button data-href="{{ route('admin.page.setting.faqs.delete', $page->id) }}" class="btn btn-danger deleteBtn">@lang('Yes, Delete it!')</button>
                                    </div>
                                </div>
                                </div>
                            </div>
    ...
    <script>
        $(document).ready(function(){
            var table = $('.datatable').DataTable({
                ...
                serverSide: true,
                responsive: true,
                ajax: "{{ route('admin.page.setting.faqs.data') }}",
                columns: [
