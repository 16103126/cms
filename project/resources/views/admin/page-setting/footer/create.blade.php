...
@section('title', __('Footer Page Setting'))
        ...
        <div class="row">
            ...
            <div class="col-sm-10">
                <nav aria-label="breadcrumb">
                    ...
                    <li class="breadcrumb-item {{ (Request::is('admin/page/setting/footer/create*')) ? 'active' : '' }}">
                        <a href="{{ route('admin.page.setting.footer.create') }}">@lang('Create Page')</a>
                    </li>
                    </ol>
                </nav>
                <div class="card mb-4">
                    ...
                    <div class="card-body mt-5">
                        <div class="row">
                            <div class="col-sm-1"></div>
                            <div class="col-sm-10">
                                <form method="POST" action="{{ route('admin.page.setting.footer.store') }}">
                                    @csrf
