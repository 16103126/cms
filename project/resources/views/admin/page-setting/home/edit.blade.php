        ...
        <div class="row">
            ...
            <div class="col-sm-10">
                <nav aria-label="breadcrumb">
                    ...
                    <li class="breadcrumb-item {{ (Request::is('admin/page/setting/home/edit*')) ? 'active' : '' }}">
                        <a href="{{ route('admin.page.setting.home.edit', $page->id) }}">@lang('Edit Page')</a>
                    </li>
                    </ol>
                </nav>
                <div class="card mb-4">
                    ...
                    <div class="card-body mt-5">
                        <div class="row">
                            <div class="col-sm-1"></div>
                            <div class="col-sm-10">
                                <form method="POST" action="{{ route('admin.page.setting.home.update', $page->id) }}">
                                    @csrf
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-sm-9">
                                          <input type="text" name="subtitle" class="form-control" id="basic-default-name" value="{{ $page->subtitle }}" required>
                                        </div>
                                    </div>
                                    <div class="row mb-5">
