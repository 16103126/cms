        ...
        <div class="row">
            ...
            <div class="col-sm-10">
                <nav aria-label="breadcrumb">
                    ...
                    <li class="breadcrumb-item {{ (Request::is('admin/page/create')) ? 'active' : '' }}">
                        <a href="{{ route('admin.page.create') }}">@lang('Create Page')</a>
                    </li>
                    </ol>
                </nav>
                <div class="card mb-4">
                            ...
                            <div class="col-sm-10">
                                <form method="POST" action="{{ route('admin.page.store') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="name" class="form-control" id="basic-default-name" placeholder="{{ __('Enter page name') }}">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label class="col-sm-3 col-form-label" for="basic-default-company">@lang('Page title')</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="title" class="form-control" id="basic-default-company" placeholder="{{ __('Enter page title') }}">
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="meta_keywords" class="form-control" id="basic-default-name" placeholder="{{ __('Enter meta keywords') }}">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label class="col-sm-3 col-form-label" for="basic-default-company">@lang('Meta description')</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="meta_description" class="form-control" id="basic-default-company" placeholder="{{ __('Enter meta description') }}">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <select id="langSeletct" name="language_id" class="form-select">
                                                ...
                                                @foreach ($languages as $language)
                                                    <option value="{{ $language->id }}" data-href="{{ route('admin.page.menu.data', $language->id) }}">{{ $language->language }}</option>
                                                @endforeach
                                              </select>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <input name="menu" class="form-check-input" type="radio" value="1" id="mainMenuRadio" checked>
                                                    <label class="form-check-label" for="mainMenuRadio"> @lang('Main menu') </label>
                                                </div>
                                                <div class="col-sm-6">
                                                    <input name="menu" class="form-check-input" type="radio" value="2" id="submenuRadio">
