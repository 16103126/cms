...
@section('title', __('Create Website Language'))
        ...
        <div class="row">
            ...
            <div class="col-sm-10">
                <nav aria-label="breadcrumb">
                    ...
                    <li class="breadcrumb-item {{ (Request::is('admin/website-language/create')) ? 'active' : '' }}">
                        <a href="{{ route('admin.website-language.create') }}">@lang('Create Website Language')</a>
                    </li>
                    </ol>
                </nav>
                <div class="card mb-4">
                    <h5 class="card-header">@lang('Create Website Language')</h5>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-1"></div>
                            <div class="col-sm-10">
                                <form method="POST" action="{{ route('admin.website-language.store') }}">
                                    @csrf
