        ...
        <div class="row">
            ...
            <div class="col-sm-10">
                <nav aria-label="breadcrumb">
                    ...
                    <li class="breadcrumb-item {{ (Request::is('admin/website-language/index')) ? 'active' : '' }}">
                        <a href="{{ route('admin.website-language.index') }}">@lang('Manage Website Language')</a>
                    </li>
                    <li class="breadcrumb-item {{ (Request::is('admin/website-language/edit*')) ? 'active' : '' }}">
                        <a href="{{ route('admin.website-language.edit', $language->id) }}">@lang('Edit Website Language')</a>
                    </li>
                    </ol>
                </nav>
                <div class="card mb-4">
                    <h5 class="card-header">@lang('Edit Website Language')</h5>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-1"></div>
                            <div class="col-sm-10">
                                <form method="POST" action="{{ route('admin.website-language.update', $language->id) }}">
                                    @csrf
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-sm-9">
                                          <input type="text" name="language" class="form-control" id="basic-default-name" value="{{ $language->language}}" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                            ...
                                            @foreach ($langData as $key => $value)
                                                <div class="row mb-3">
                                                    <div class="col-sm-5 mb-2">
                                                        <input type="text" name="keys[]" class="form-control" id="basic-default-name" value="{{ $key }}" required>
                                                    </div>
                                                    <div class="col-sm-5 mb-2">
                                                        <input type="text" name="values[]" class="form-control" id="basic-default-name" value="{{ $value }}" required>
                                                    </div>
                                                </div>
                                            @endforeach
                                        </div>
