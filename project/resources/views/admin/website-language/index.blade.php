...
@section('title', __('Manage WesiteLanguage'))
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
            ...
            <div class="col-sm-10">
                ...
                <div class="card mb-4">
                    <h5 class="card-header">@lang('Manage Website Language')</h5>
                    <div class="card-header">
                        <a href="{{ route('admin.website-language.create') }}" class="btn btn-primary">@lang('Add Language')</a>
                    </div>
                    <div class="card-body">
                        ...
                        @foreach ($languages as $language)
                            <div class="modal fade" id="deleteLanguage{{ $language->id }}" tabindex="-1" style="display: none;" aria-hidden="true">
                                ...
                                <div class="modal-content">
                                    ...
                                    <button data-href="{{ route('admin.website-language.delete', $language->id) }}" class="btn btn-danger deleteBtn">@lang('Yes, Delete it!')</button>
                                    </div>
                                </div>
                                </div>
                            </div>
    ...
    <script>
        $(document).ready(function(){
            var table = $('.datatable').DataTable({
                ...
                serverSide: true,
                responsive: true,
                ajax: "{{ route('admin.website-language.data') }}",
                columns: [
