...
>
  <head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{ asset('assets/admin/img/icons/'.generalSetting()->dashboard_icon) }}" />
  ...
  <body>
    <div class="row">
      <div class="col-sm-12">
        <h5><i class='bx bx-chevrons-left'></i><a href="{{ route('home') }}">@lang('Go to Home')</a></h5>
      </div>
    </div>
    <!-- Content -->
    ...
    <script src="{{ asset('assets/auth/js/registration-form.js') }}"></script>
