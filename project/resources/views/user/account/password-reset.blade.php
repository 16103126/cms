                ...
                <div class="col-sm-10">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-style1">
                          ...
                          <li class="breadcrumb-item {{ (Request::is('user/account/password/reset')) ? 'active' : '' }}">
                            <a href="{{ route('user.account.password.reset.form') }}">@lang('Password Reset')</a>
                          </li>
                        </ol>
                    </nav>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form action="{{ route('user.account.password.reset', $user->id) }}" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-sm-1">
                                    </div>
